      ...
      <div className='flex flex-col gap-8 sm:bg-web-blue sm:p-3 '>
        ...
        >
          ...
          <div className="flex flex-col gap-5 sm:row-start-1 sm:row-span-4 sm:order-1">
            <figure >
              <div className="max-w-full sm:h-auto bg-web-gray">
          ...
          <div className="flex flex-col gap-2 sm:order-3 sm:col-span-2">
            <h3 className='text-2xl font-extrabold text-center text-web-blue leading-normal sm:text-left'>Tecnologías usadas</h3>
            <IconContext.Provider value={{ size: "2em" }}>
          ...
          <div className='sm:order-4  sm:col-span-2'>
            <h3 className='text-2xl font-extrabold text-center text-web-blue leading-normal sm:text-left'>Descripción del Proyecto</h3>
